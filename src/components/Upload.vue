      ...
      <v-content>
        <v-container fluid>
          <v-layout align-center justify-center>
            <v-flex xs12 sm8 md4>
              <v-text-field label="Select Image" @click="pickFile" v-model="imageName" prepend-icon="mdi-paperclip"></v-text-field>
              <input
                type="file"
                style="display: none"
                ref="image"
          ...
          <v-layout align-center justify-center>
            <v-flex xs12 sm8 md4>
              <v-progress-linear id="progress" :value="uploadValue" max="100" style="min-height: 4px; display: none"></v-progress-linear>
            </v-flex>
          </v-layout>
          <v-layout align-left>
